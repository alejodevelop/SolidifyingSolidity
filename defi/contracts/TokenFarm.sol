...
// Nos va a dar la seguridad pertinente a todas estas acciones
// El token farm nos va a permitir juntar ambos previos tokens controlarlos en un mismo proyecto
...
contract TokenFarm {
    ...
    function stakeTokens(uint _amount) public {
        ...
        // Transferir tokens Jam al Smart Contract principal (TokenFarm este mismo contrato)
    ...
    // Devolver tokens en staking, quitar el staking de los tokens
