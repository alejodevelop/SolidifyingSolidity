...
contract("customERC20", accounts => {
    ...
    it("increaseAllowance & decreaseAllowance", async () => {
        ...
        let _allowance5_50 = await instance.allowance(accounts[0], addr);
        assert.equal(_allowance5_50, 100 + 200 - 50);
