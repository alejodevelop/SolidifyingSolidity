...
contract loteria is ERC20, Ownable {
    ...
    constructor() ERC20("Loteria", "JA"){
        // Estamos generando tokens cuando el contrato sea desplegado y almacenandolos en el smart contract
    ...
    // Esta funcion es un FACTORY, una funcion que permite la creacion de otros Smart Contracts automaticamente
    ...
    function compraTokens(uint256 _numTokens) public payable {
        ...
        // El Smart Contract devuelve la cantidad restante de ethers
    ...
    // Relacion: persona que compra los boletos -> numero de los boletos
    ...
    function compraBoletos(uint _numBoletos) public {
        ...
        for(uint i =0; i < _numBoletos; i++){
            // Al operar el modulo con el hash aleatorio recien creado (convertido en entero), establecemos cuantas cifras queramos que tenga el numero
            // en este caso queremos que el numero vaya de 0 hasta 9999
...
// Smart Contract NFTs
// Este contrato se despliega de manera automatica en el constructor del contrato de loteria principal
contract mainERC721 is ERC721 {

    address public direccionLoteria;

    constructor() ERC721("Loteria", "STE"){
        // Direccion del contrato principal cuando se despliega por primera vez
        direccionLoteria = msg.sender;
    }

    // Creacion de NFTs
    // Queremos que cada boleto de loteria sea un token NFT
    // Esta funcion solo sera ejecutable por el contrato boletosNFTs
...
contract boletosNFTs {
    ...
    // Datos relevante del propietario
    struct Owner {
